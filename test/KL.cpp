    ...
    std::vector<cv::Point2f> prev_subset, std::vector<cv::Point2f> next_subset)
{
    ...
    normalisation_mat.at<double>(0, 0) = (0.001);
    normalisation_mat.at<double>(0, 1) = 0;
    normalisation_mat.at<double>(0, 2) = 0;
    normalisation_mat.at<double>(1, 0) = 0;
    normalisation_mat.at<double>(1, 1) = (0.001);
    normalisation_mat.at<double>(1, 2) = 0;
    ...
    {
        m1=convert_to_homogenous(next_subset[i]);
        m2=convert_to_homogenous(prev_subset[i]); 
        m1 = normalisation_mat * m1;
        m2 = normalisation_mat * m2;
